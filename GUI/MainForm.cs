...
namespace GUI {
    public sealed partial class MainForm : Form {
        ...
        private void Redraw(BitField bitfield, bool top) {
            ...
            ctx[3].Text = EnumExtensions.GetAllSelectedItems<Flag>(bitfield.Mask).ToList().Aggregate(string.Empty, (current, enm) => current + (current.Length > 0 ? " | " : string.Empty) + enm.GetEnumDescription());
        ...
        private void PictureBoxLogo_Click(object sender, EventArgs e) => Process.Start("https://github.com/Latency/Bitfields");
        ...
        private void History_Click(object sender, EventArgs e) {
            ...
            var hBitField = new BitField {
                Mask = Convert.ToUInt64(sVal, 10)
            };
