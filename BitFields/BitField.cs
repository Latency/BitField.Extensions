...
namespace BitFields {
    ...
    public class BitField {
        ...
        ///     Copy Contructor
        /// </summary>
        public BitField(ulong mask) => Mask = mask;
        ...
        private void SetField(ulong mask) => Mask = mask;
        ...
        /// </example>
        /// <param name="mask">The mask to set in Field</param>
        public void SetOn(ulong mask) => Mask |= mask;
        ...
        public void SetOff(ulong mask) => Mask &= ~mask;
        ...
        public void Toggle(ulong mask) => Mask ^= mask;
        ...
        ///     false otherwise
        /// </returns>
        public bool IsSet(ulong mask, bool compareAll = false) => !compareAll ? (Mask & mask) != 0 : (Mask & mask) == mask;
        ...
        ///     false otherwise
        /// </returns>
        public bool IsEqual(ulong mask) => Mask == mask;
